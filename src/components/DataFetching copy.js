              ...
              <Grid item xs={3}>
                <Typography variant="body2" gutterBottom>
                  <Img
                    alt="complex"
                    src={
                      "https://d1pnlk307kfyn2.cloudfront.net" + post.images[0]
                    }
           ...
           <Box sx={style}>
              <Typography id="keep-mounted-modal-description" sx={{ mt: 2 }}>
                 {post.equipment.more}
                        ...
                        <a href="" title={post.equipment.more} className="a">
                          Afficher plus d'équipements
                        </a>
                        <br />
                        <a href="" title={post.terms}>
                ...
                <Grid xs={5}>
                  <Typography variant="subtitle1" component="div" container>
                    ...
                    <div className="Img-phrase-container">
                      <Img
                        src="https://www.citygo.tn/assets/img/check.png"
                        alt=""
                      />
